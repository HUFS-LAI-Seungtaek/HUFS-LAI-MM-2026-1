...
- `members/` 디렉토리에 자기소개를 작성해서 PR로 제출하세요!
    - [https://github.com/HUFS-LAI-Seungtaek/HUFS-LAI-MM-2026-1](https://github.com/HUFS-LAI-Seungtaek/HUFS-LAI-MM-2026-1) 접속
    - `Fork` 버튼 클릭하여 `Create Fork` 진행
    - Fork한 repository(예: [https://github.com/hist0613/HUFS-LAI-MM-2026-1](https://github.com/hist0613/HUFS-LAI-MM-2026-1))로 이동 확인 후
    ...
    - `members/{본인이름}.md` 파일에 간단한 자기소개 작성 후 (`members/seungtaek.md` 참고) `Commit changes...` 버튼 클릭
        ...
        - 자기소개 내용은 [members/seungtaek.md](https://github.com/HUFS-LAI-Seungtaek/HUFS-LAI-MM-2026-1/tree/main/members/seungtaek.md) 참고
